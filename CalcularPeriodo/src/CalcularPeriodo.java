...
public class CalcularPeriodo {
	...
	public static void main(String[] args) {
		...
		LocalDate fecha1 = LocalDate.of(2006, Month.SEPTEMBER, 28);
		calcularPeriodo("Pok�mon Diamante sale al mercado", fecha1);
		
		LocalDate fecha2 = LocalDate.of(2010, Month.SEPTEMBER, 18);
		calcularPeriodo("Pok�mon Blanco sale al mercado", fecha2);
	}
